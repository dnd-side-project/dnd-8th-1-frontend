  ...
  return (
    <>
      ...
      >
        ...
        {isBanner && (
          <div className="absolute bottom-[-34px] left-[42px] flex h-[38px] w-[251px] items-center rounded-tr-[16px] rounded-br-[16px] rounded-bl-[16px] bg-gray-100 py-[9px] px-[14px]">
